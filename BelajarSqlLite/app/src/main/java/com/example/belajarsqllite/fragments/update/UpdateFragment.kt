package com.example.belajarsqllite.fragments.update
...
class UpdateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.edt_updata_nama_dosen.setText(args.curJadwal.namaDosen)
    ...
    private fun updateItem() {
        ...
        val nm_dosen = edt_updata_nama_dosen.text.toString()
