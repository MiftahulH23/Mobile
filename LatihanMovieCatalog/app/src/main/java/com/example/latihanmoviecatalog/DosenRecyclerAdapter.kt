...
import com.example.latihanmoviecatalog.databinding.LayoutListCatalogBinding
...
class DosenRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DosenViewHolder {
        val binding = LayoutListCatalogBinding.inflate(LayoutInflater.from(parent.context),
            parent, false)
    ...
    class DosenViewHolder constructor(val binding: LayoutListCatalogBinding): RecyclerView.ViewHolder(binding.root) {
